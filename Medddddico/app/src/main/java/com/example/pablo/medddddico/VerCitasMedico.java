...
public class VerCitasMedico extends PrincipalMedico {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isNetworkAvailable()){
                    ...
                    .setPositiveButton("Salir de la aplicación",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    ActivityCompat.finishAffinity(VerCitasMedico.this);
            ...
            list = (ListView)findViewById(R.id.listViewMedico);
            ...
            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent intentVerCitasMedicoXPaciente = new Intent(VerCitasMedico.this,VerCitasMedicoXPaciente.class);
                    intentVerCitasMedicoXPaciente.putExtra("DNIMedico",getIntent().getStringExtra("DNI"));
                    intentVerCitasMedicoXPaciente.putExtra("DNIPaciente",DNIcitas.get(position));
                    startActivity(intentVerCitasMedicoXPaciente);
                }
            });
        }
