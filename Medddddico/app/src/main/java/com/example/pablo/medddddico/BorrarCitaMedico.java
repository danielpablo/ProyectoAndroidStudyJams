...
public class BorrarCitaMedico extends PrincipalMedico {

    private ListView list;
    private ArrayList<String> citasArrayList = new ArrayList<>();
    private ArrayList<String> DNIcitas = new ArrayList<>();
    private int color;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isNetworkAvailable()){
                    ...
                    .setPositiveButton("Salir de la aplicación",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    ActivityCompat.finishAffinity(BorrarCitaMedico.this);
                                }
                            });
            ...
            cargar.execute();
            setContentView(R.layout.activity_borrar_cita_medico);
            cargarDatos();
            ...
            list = (ListView)findViewById(R.id.listViewBorrarCitaMedico);
            ...
            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent intentBorrarCitaXPaciente = new Intent(BorrarCitaMedico.this,BorrarCitaMedicoXPaciente.class);
                    intentBorrarCitaXPaciente.putExtra("DNIMedico",getIntent().getStringExtra("DNI"));
                    intentBorrarCitaXPaciente.putExtra("DNIPaciente",DNIcitas.get(position));
                    startActivity(intentBorrarCitaXPaciente);
                }
            });
        }
    ...
    public void inicializarCitas(String resultado, String dni){
        ...
        try{
            ...
            JSONObject datos = object.getJSONObject("Medico").getJSONObject(getIntent().getStringExtra("DNI")).getJSONObject("Pacientes");
            Iterator<String> claves = datos.keys();
            while(claves.hasNext()){
                String clave = claves.next();
                if(!clave.equals(" ")) {
                    citasArrayList.add("Paciente: "+clave);
                    DNIcitas.add(clave);
                }
            }
